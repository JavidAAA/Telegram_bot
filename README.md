...
This is a Python-based asynchronous Telegram bot that interacts with users on Telegram. The bot responds to user messages, mentions, and replies in private chats and groups. It integrates with the Eden API and supports sending both text messages and media (photos) as responses.
...
Make sure the .env file contains the required TELEGRAM_TOKEN for the bot to work correctly.
